  ...
  return (
    ...
    <tbody className=" divide-y divide-gray-200">
        <tr>
            ...
            <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm text-gray-900">Address line 1 </div>
                <div className="text-sm text-gray-500">Address line 2</div>
            </td>
          
           
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500" typeof='phone'>
                +251926859686
            </td>
            <td className="px-6 py-4 whitespace-nowrap">
            ...
            <button id="editFaq" className="hover:text-green-700 hover:scale-125  text-green-600 px-3 " >
            ...
            <button id="deleteMeal" className="hover:text-green-700 hover:scale-125  text-green-600  px-3 "  > {/* onClick={() => setDeleteModalOpen(true)}*/}
              <svg
