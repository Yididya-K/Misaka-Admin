...
const FaqCreateModal: React.FC<CreateModalProps> = ({ isOpen, onClose, onCreate }) => {
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[70vh]">
          <form>
            ...
            <div className="col-span-full">
                <label htmlFor="description" className="text-sm font-medium text-gray-900 block mb-2">Quest</label>
                <textarea
                  id="question"
                  name="question"
              ...
              <div className="col-span-full">
                <label htmlFor="description" className="text-sm font-medium text-gray-900 block mb-2">Answer</label>
                <textarea
                  id="answer"
                  name="answer"
