...
interface DeleteModalProps {
  ...
  Meal: {
    name: string;
    category: string[]; // Multiple categories selected from dropdown
    calories: string;
    image: string;
    plan: string[]; // Multiple plans selected from dropdown
    day: string[];
  };
}


const UserDeleteModal: React.FC<DeleteModalProps> = ({ isOpen, onClose, onDelete,Meal }) => {
