    ...
    <div>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-1/2 lg:w-1/3 h-1/2 lg:h-1/3 px-2 md:px-4 mb-4">
            <div className="relative bg-white border border-gray-100 rounded-lg overflow-hidden shadow-lg">
              <div className="relative overflow-hidden h-60 md:h-80 lg:h-96">
                <img
                  className="object-cover w-full h-full"
                  src="https://images.unsplash.com/photo-1484980972926-edee96e0960d?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Low Cal"
                />
                <div className="absolute top-6 left-0 px-4 py-2 bg-orange-300 bg-opacity-75 rounded-r-xl">
                  <span className="text-xs font-medium text-gray-600 uppercase block">
                    Low Cal
                  </span>
              ...
              <div className="p-4 h-auto md:h-1/5 lg:h-20">
                <h2 className="text-lg font-semibold text-center mb-2 font-black">
                  Low cal
                </h2>
              ...
              <div className="flex justify-center p-5 border-t-2 hover:bg-green-900 border-gray-100 hover:text-white">
                <p className="text-sm md:text-lg font-bold">ORDER</p>
              </div>
            </div>
          </div>
          <div className="w-1/2 lg:w-1/3 h-1/2 lg:h-1/3 px-2 md:px-4 mb-4">
